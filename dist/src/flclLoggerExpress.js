...
exports.FlclLoggerExpress = void 0;
...
class FlclLoggerExpress {
    ...
    _getStringified(jsonObj) {
        let stringified = '';
        try {
            stringified = JSON.stringify(jsonObj, FlclLoggerExpress.replacer, 4);
        }
        catch (e) {
            if (jsonObj && jsonObj.response && jsonObj.response.data) {
                ...
                stringified = JSON.stringify({ identifier: 'INVALID_JSON_CIRCULAR_JSON', message: jsonObj.message || 'This is circular json. Could not able to convert', stackTrace: this._getStackTrace() }, FlclLoggerExpress.replacer, 4);
            }
        }
        finally {
            return stringified;
...
exports.FlclLoggerExpress = FlclLoggerExpress;
//# sourceMappingURL=flclLoggerExpress.js.map